...
btn.addEventListener('click', function() {
    ...
    demo4.innerHTML = '<img src="L.png" alt="" style="width: 200px; height: 200px; " class="myimg">';
    demo1.innerHTML = '<img src="L.png" alt="" style="width: 200px; height: 200px; " class="myimg">';
